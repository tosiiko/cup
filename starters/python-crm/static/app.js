import { mountRemoteView, validateProtocolView } from '/dist/index.js';
...
const FORM_ENDPOINTS = {
  ...
  create_lead: '/api/leads/create',
  rotate_session: '/api/security/rotate-session',
  terminate_other_sessions: '/api/security/terminate-others',
};
...
function fatalError(error) {
  console.error('[CUP CRM Starter]', error);
  const panel = document.createElement('div');
  panel.className = 'fatal';

  const title = document.createElement('h1');
  title.textContent = 'CRM request failed';
